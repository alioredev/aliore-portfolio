...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="section-padding px-4 sm:px-6 md:px-12 max-w-6xl mx-auto relative"
    >
      ...
      <div className="grid md:grid-cols-2 gap-16 items-start relative z-10">
        ...
        >
          <h2
            className="text-4xl md:text-5xl font-normal leading-snug mb-8"
            style={{
              fontFamily: "'Playfair Display', Georgia, serif",
              color: "var(--text)",
            }}
          ...
          <div className="flex gap-6">
            {[
              ...
              { label: t("linkedin"), href: siteConfig.linkedin },
            ].map(({ label, href }) => (
              <a
                key={label}
                href={href}
